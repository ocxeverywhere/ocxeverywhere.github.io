...
{% include link-preview.html url="https://link.coupang.com/a/fdyeSLJCdE" title="카카오프렌즈 CS 형태 무선 마우스 식빵 춘식" description="로블록스 게임 플레이에 사용한 춘식이 무선 마우스입니다." image="/assets/images/posts/coupang-mouse.jpg" alt="춘식이 무선 마우스 미리보기" sponsored=true %}

![구독자 1,000명을 기념하는 Jiun Games YouTube 채널 화면](/assets/images/posts/jiun-game-channel.png)

*구독자 1,000명을 기념하는 Jiun Games YouTube 채널 화면*

{% include link-preview.html url="https://www.youtube.com/channel/UC2r3Z3jOIA9laB1P8O8sUxg" title="지운 게임 YouTube 채널" description="LazyDaddy Game Recording으로 만든 로블록스 게임 영상을 확인하세요." image="/assets/images/posts/jiun-game-youtube-preview.png" alt="검정색과 금색 디자인의 Jiun Game YouTube 채널 미리보기" %}

로블록스는 여기 핀란드 초딩들도 정말 많이 하고, 이런 것들도 생일선물로 인기다.

{% include link-preview.html url="https://link.coupang.com/a/fdxK6RDIM8" title="ROBLOX 필통 로블록스 선물용 굿즈" description="로블록스를 좋아하는 어린이를 위한 필통 굿즈입니다." image="/assets/images/posts/coupang-roblox-case.jpg" alt="로블록스 필통 미리보기" sponsored=true %}
...
![로블록스 라이벌 게임 플레이 영상 화면](/assets/images/posts/roblox-rivals-28k-video.png)

*알고리즘을 타고 28K 조회수를 기록한 로블록스 라이벌 게임 영상*
...
![LazyDaddy Game Recording으로 녹화한 로블록스 라이벌 PIP 영상](/assets/images/posts/lazydaddy-game-recording-pip.png)

*LazyDaddy Game Recording v1.0.8의 PIP 기능을 사용한 게임 녹화 화면*
...
{% include link-preview.html url="https://link.coupang.com/a/fdx5HUfYqa" title="OMIIYA 가상 7.1채널 USB 게이밍 헤드셋" description="게임 녹화와 음성 리액션에 사용할 수 있는 USB 헤드셋입니다." image="/assets/images/posts/coupang-headset.jpg" alt="USB 게이밍 헤드셋 미리보기" sponsored=true %}

그리고는 마침내 오늘 드디어 마이크로소프트 스토어에 등록이 되었다고 알림을 받았다.

![Microsoft Store에 등록된 LazyDaddy Game Recording 앱 페이지](/assets/images/posts/microsoft-store-lazydaddy-game-recording.png)

*Microsoft Store에 정식 등록된 LazyDaddy Game Recording*
